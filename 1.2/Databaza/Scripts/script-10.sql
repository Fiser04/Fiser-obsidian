...
CREATE TABLE Battle(
    ...
    battle_mode NVARCHAR(MAX) NOT NULL,
...
--    equipment_usage_id BIGINT IDENTITY(1,1),
    ...
    PRIMARY KEY(equipment_usage_equipment_id, equipment_usage_participation_id, equipment_usage_slot),
...
--    result_id BIGINT NOT NULL,
    result_participation_id BIGINT NOT NULL,
    result_result_row_id INT NOT NULL,
    PRIMARY KEY(result_participation_id, result_result_row_id),
    FOREIGN KEY (result_participation_id) REFERENCES Participation(participation_id),
    FOREIGN KEY (result_result_row_id) REFERENCES Result_Row(result_row_id),
);
