...
CREATE TABLE Tank_Stat(
	...
	stat_row_id INT NOT NULL,
	PRIMARY KEY (tank_id, version_id, stat_row_id),
	FOREIGN KEY (tank_id) REFERENCES Tank(id),
	FOREIGN KEY (version_id) REFERENCES Version(id),
	FOREIGN KEY (stat_row_id) REFERENCES Stat_Row(id)
);
...
-- Insert Tank Types
SET IDENTITY_INSERT Tank_Type ON;
INSERT INTO Tank_Type (id, name, description) VALUES (1, 'Standard', 'Regular tech tree tank');
SET IDENTITY_INSERT Tank_Type OFF;

-- Insert Tank Classes
SET IDENTITY_INSERT Tank_Class ON;
...
SET IDENTITY_INSERT Stat_Category ON;
...
-- Insert Tank_Stat
--SET IDENTITY_INSERT Tank_Stat ON;
...
--SET IDENTITY_INSERT Tank_Stat OFF;


-- Insert Battle Maps
SET IDENTITY_INSERT Battle_Map ON;
...
SET IDENTITY_INSERT Battle_Map OFF;

-- Insert Battle Types
SET IDENTITY_INSERT Battle_Type ON;
...
SET IDENTITY_INSERT Battle_Type OFF;

-- Insert Battles
SET IDENTITY_INSERT Battle ON;
...
SET IDENTITY_INSERT Battle OFF;
